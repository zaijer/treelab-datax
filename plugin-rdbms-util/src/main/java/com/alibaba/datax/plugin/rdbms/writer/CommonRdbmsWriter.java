...
public class CommonRdbmsWriter {
    ...
    public static class Task {
        ...
        protected void doBatchInsert(Connection connection, List<Record> buffer)
            ...
            try {
                ...
                preparedStatement = connection
                        .prepareStatement(treelabSqlFix(this.writeRecordSql));
        ...
        protected String treelabSqlFix(String sql){
            /** fix a column named 'ORDER' of column table */
            sql = sql.replace("ORDER,ISARCHIVED,ARCHIVEDAT","`ORDER`,ISARCHIVED,ARCHIVEDAT");
            /** fix a column named 'ORDER' of node table */
            sql = sql.replace("ORDER,NAME,NODETYPE","`ORDER`,NAME,NODETYPE");
            /** fix a column named 'ORDER' of VIEW table */
            sql = sql.replace("ORDER,ISDEFAULT,ISARCHIVED","`ORDER`,ISDEFAULT,ISARCHIVED");
            return sql;
        }
